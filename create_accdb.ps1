...
try {
    ...
    # 재고 (기준일 2026-06-19)
    $inv = @(
        "(1,23,10,'개',#6/19/2026#,'active')",  "(1,26,1,'모',#6/20/2026#,'active')",
        "(1,4,1,'대',#6/20/2026#,'active')",    "(1,20,1,'팩',#6/20/2026#,'active')",
        "(1,18,2,'마리',#6/21/2026#,'active')", "(1,9,1,'단',#6/21/2026#,'active')",
        "(1,11,1,'봉',#6/21/2026#,'active')",   "(1,21,1,'마리',#6/21/2026#,'active')",
        "(1,22,1,'봉',#6/21/2026#,'active')",   "(1,17,1,'팩',#6/21/2026#,'active')",
        "(1,15,1,'팩',#6/22/2026#,'active')",   "(1,13,1,'팩',#6/22/2026#,'active')",
        "(1,33,3,'개',#6/22/2026#,'active')",   "(1,27,1,'팩',#6/22/2026#,'active')",
        "(1,28,1,'팩',#6/22/2026#,'active')",   "(1,29,1,'봉',#6/22/2026#,'active')",
        "(1,3,2,'개',#6/25/2026#,'active')",    "(1,1,3,'개',#6/27/2026#,'active')",
        "(1,34,1,'팩',#6/28/2026#,'active')",   "(1,24,1,'팩',#6/23/2026#,'active')",
        "(1,35,1,'병',#1/4/2027#,'active')",    "(1,36,1,'통',#1/4/2027#,'active')",
        "(1,37,1,'통',#1/4/2027#,'active')",    "(1,38,1,'병',#1/4/2027#,'active')",
        "(1,40,1,'개',#1/4/2027#,'active')"
    )
    foreach ($r in $inv) {
    ...
    # 소진 기록 (5월 19일~6월 19일, 50건)
    $logs = @(
        # --- 5월 ---
        "(1,Null,23,3,'cooked',2,'개',120,#5/19/2026#)",
        "(1,Null,26,1,'cooked',1,'모',300,#5/20/2026#)",
        "(1,Null,9,4,'cooked',1,'단',200,#5/20/2026#)",
        "(1,Null,16,6,'cooked',1,'팩',500,#5/21/2026#)",
        "(1,Null,23,3,'cooked',2,'개',120,#5/21/2026#)",
        "(1,Null,12,7,'cooked',1,'봉',200,#5/22/2026#)",
        "(1,Null,10,1,'cooked',1,'개',250,#5/22/2026#)",
        "(1,Null,23,3,'cooked',2,'개',120,#5/23/2026#)",
        "(1,Null,9,Null,'cooked',1,'단',200,#5/23/2026#)",
        "(1,Null,10,1,'cooked',1,'개',250,#5/24/2026#)",
        "(1,Null,4,3,'cooked',1,'대',100,#5/25/2026#)",
        "(1,Null,12,Null,'cooked',1,'봉',200,#5/25/2026#)",
        "(1,Null,20,10,'cooked',1,'팩',200,#5/25/2026#)",
        "(1,Null,13,2,'cooked',1,'팩',500,#5/26/2026#)",
        "(1,Null,4,2,'cooked',1,'대',100,#5/26/2026#)",
        "(1,Null,26,8,'cooked',1,'모',300,#5/27/2026#)",
        "(1,Null,15,6,'cooked',1,'팩',400,#5/28/2026#)",
        "(1,Null,18,Null,'wasted',1,'마리',400,#5/29/2026#)",
        "(1,Null,33,Null,'cooked',2,'개',240,#5/30/2026#)",
        # --- 6월 ---
        "(1,Null,23,3,'cooked',2,'개',120,#6/2/2026#)",
        "(1,Null,21,10,'cooked',1,'마리',300,#6/2/2026#)",
        "(1,Null,12,7,'cooked',1,'봉',200,#6/2/2026#)",
        "(1,Null,26,1,'cooked',1,'모',300,#6/3/2026#)",
        "(1,Null,4,1,'cooked',1,'대',100,#6/3/2026#)",
        "(1,Null,17,9,'cooked',1,'팩',400,#6/5/2026#)",
        "(1,Null,3,Null,'cooked',2,'개',400,#6/5/2026#)",
        "(1,Null,9,4,'cooked',1,'단',200,#6/6/2026#)",
        "(1,Null,23,3,'cooked',2,'개',120,#6/6/2026#)",
        "(1,Null,20,10,'cooked',1,'팩',200,#6/7/2026#)",
        "(1,Null,23,Null,'cooked',3,'개',180,#6/7/2026#)",
        "(1,Null,18,Null,'cooked',1,'마리',400,#6/8/2026#)",
        "(1,Null,28,9,'cooked',1,'팩',150,#6/8/2026#)",
        "(1,Null,14,2,'cooked',1,'팩',400,#6/9/2026#)",
        "(1,Null,23,3,'cooked',2,'개',120,#6/10/2026#)",
        "(1,Null,16,6,'cooked',1,'팩',500,#6/11/2026#)",
        "(1,Null,1,Null,'cooked',3,'개',450,#6/11/2026#)",
        "(1,Null,6,Null,'cooked',1,'개',120,#6/11/2026#)",
        "(1,Null,26,1,'cooked',1,'모',300,#6/12/2026#)",
        "(1,Null,4,1,'cooked',1,'대',100,#6/12/2026#)",
        "(1,Null,20,10,'cooked',1,'팩',200,#6/13/2026#)",
        "(1,Null,23,3,'cooked',2,'개',120,#6/14/2026#)",
        "(1,Null,11,Null,'cooked',1,'봉',100,#6/14/2026#)",
        "(1,Null,39,Null,'cooked',20,'g',20,#6/15/2026#)",
        "(1,Null,15,6,'cooked',1,'팩',400,#6/16/2026#)",
        "(1,Null,23,3,'cooked',2,'개',120,#6/17/2026#)",
        "(1,Null,29,1,'cooked',1,'봉',150,#6/17/2026#)",
        "(1,Null,13,Null,'cooked',250,'g',250,#6/18/2026#)",
        "(1,Null,11,Null,'cooked',1,'봉',100,#6/18/2026#)",
        "(1,Null,26,Null,'cooked',1,'모',150,#6/19/2026#)",
        "(1,Null,23,3,'cooked',2,'개',120,#6/19/2026#)"
    )
    foreach ($r in $logs) {
