...
-- ERD 버전: v0.6 (소비기한 기능 반영: shelf_days·expiry_ext_days 추가, expires_at→소비기한 기준)
-- ============================================================
...
CREATE TABLE ingredients (
    ...
    shelf_days         INT          NOT NULL DEFAULT 7  COMMENT '냉장 소비기한(일) — 농진청·식약처 기준',
    expiry_ext_days    INT          NOT NULL DEFAULT 0  COMMENT '유통기한→소비기한 연장일(식약처 소비기한 참고값, 0=해당없음)',
    created_at         TIMESTAMP    NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- (name, category_id, default_unit, weight_per_unit_g, carbon_per_100g, shelf_days, expiry_ext_days)
...
('고구마',     1, '개',  200.00, 0.0430, 14,  0),
('양파',       1, '개',  200.00, 0.0500, 30,  0),
('대파',       1, '대',  100.00, 0.0300,  7,  0),
('마늘',       1, '통',   50.00, 0.0360, 30,  0),
('당근',       1, '개',  120.00, 0.0420, 14,  0),
('무',         1, '개',  800.00, 0.0380, 14,  0),
('배추',       1, '통', 2000.00, 0.0310, 14,  0),
('시금치',     1, '단',  200.00, 0.0350,  4,  0),
('애호박',     1, '개',  250.00, 0.0280,  7,  0),
('상추',       1, '봉',  100.00, 0.0250,  3,  0),
('콩나물',     1, '봉',  200.00, 0.0220,  3,  0),
-- 육류 (cat 2)
('돼지고기(삼겹살)',   2, '팩', 500.00, 0.7100,  3,  0),
('돼지고기(불고기용)', 2, '팩', 400.00, 0.7100,  3,  0),
('닭가슴살',           2, '팩', 400.00, 0.6900,  2,  0),
('닭볶음탕용',         2, '팩', 500.00, 0.6900,  2,  0),
('소고기(불고기용)',   2, '팩', 400.00, 2.1000,  3,  0),
-- 해산물 (cat 3)
('고등어',   3, '마리', 400.00, 0.4300,  2,  0),
('갈치',     3, '마리', 350.00, 0.4100,  2,  0),
('새우',     3, '팩',   200.00, 0.6800,  2,  0),
('오징어',   3, '마리', 300.00, 0.5200,  2,  0),
('바지락',   3, '봉',   200.00, 0.3900,  2,  0),
-- 달걀/유제품 (cat 4) — expiry_ext_days: 식약처 소비기한 참고값
('달걀',   4, '개',  60.00, 0.1800, 28, 25),
('우유',   4, '팩', 900.00, 0.0900, 10, 50),
('버터',   4, '팩', 200.00, 0.3200, 30, 30),
-- 두부/콩류 (cat 5)
('두부',   5, '모', 300.00, 0.0700,  4,  3),
('순두부', 5, '팩', 300.00, 0.0700,  3,  3),
-- 버섯류 (cat 6)
('표고버섯',   6, '팩', 150.00, 0.0410,  5,  0),
('팽이버섯',   6, '봉', 150.00, 0.0380,  5,  0),
-- 곡류/면류 (cat 7)
('쌀',   7, '봉', 1000.00, 0.1600, 180,   0),
('라면', 7, '개',  120.00, 0.3800, 180, 240),
-- 과일 (cat 8)
('사과',  8, '개', 250.00, 0.0430, 30,  0),
('바나나',8, '개', 120.00, 0.0480,  5,  0),
('딸기',  8, '팩', 300.00, 0.0370,  3,  0),
-- 조미료/양념 (cat 9)
('간장',           9, '병', 1000.00, 0.0200, 365,  0),
('된장',           9, '통',  500.00, 0.0250, 365,  0),
('고추장',         9, '통',  500.00, 0.0270, 365,  0),
('참기름',         9, '병',  500.00, 0.0300, 180,  0),
('고춧가루',       9, '봉',  100.00, 0.0310, 180,  0),
('다진마늘(튜브)', 9, '개',  100.00, 0.0360,  30,  0),
-- 기타 (cat 10)
('멸치', 10, '봉', 100.00, 0.3100, 90, 0);
